...
using WebApiEF_DatabaseFirstApproach.Models;

namespace WebApiEF_DatabaseFirstApproach.Controllers
{
    [ApiController]
    ...
    public class StudentController : ControllerBase
    {
        ...
        public StudentController(DatabaseFirstApproachContext context)
        {
            _context = context;
        }
        [HttpGet]
